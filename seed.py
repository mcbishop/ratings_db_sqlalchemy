...
def load_movies():
    ...
    # Read u.item file and insert movie data into the database.
    # split rows divided by pipe; remove date suffix from movie title
    for row in open("seed_data/u.item"):
        ...
        # convert released_at date string into datetime object
        if (not movie_id or
            not title or
            not released_at):
            continue
